...
**v0.13.0 人物关系与宝物开发版。** 新增仲介结义婚姻、宝物持有/搜索/赏赐/战斗效果、PK局面编辑与可复用新武将模板。写v12、读v1—v11。菜单→PK编辑 / 新武将；“相知寻宝”可试玩完整新增流程。[实现范围与未完成项](docs/ESTATES_V0_13.md)。**仍未达到100%还原**；全国原版地图和官方完整开局尚缺可核验数据。
