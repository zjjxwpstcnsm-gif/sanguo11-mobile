...
全部核心回归（含100条新增外交断言）、51,788条UI模型断言、19项内容测试及Android Java编译通过；完整Android构建/Lint、三屏运行与覆盖升级正在CI验收。[本轮范围与规则边界](docs/DIPLOMACY_VISUALS_V0_21.md)。**仍未达到100%还原**：官方全国逐格地图、完整官方开局、全部事件/交互与精确公式仍有缺口；素材为原创2D表现。
