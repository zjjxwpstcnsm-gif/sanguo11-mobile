...
**v0.22.0 部队指令与设施攻防开发版。** 新增内政设施耐久、普通攻击、兵器战法与火场损伤；设施摧毁后清理施工/军备制造并释放地块。选中部队显示固定「行军 / 攻击 / 战法 / 计略 / 取消选中」；显式选择行军后才点空地预览，普通空地点选、本队再点及返回键可取消。青色显示实际剩余移动范围，红框显示当前可攻击目标。存档v18兼容v1—v17。见 [本轮实现与边界](docs/UNIT_COMMANDS_V0_22.md)。核心/UI/内容、构建/Lint、API29三屏横竖屏操作和v0.9覆盖升级全部通过。[APK与验证记录](docs/validation/v022/README.md)。
