...
**v0.20.0 战果与地图模型开发版。** 击破缴获剩余金粮，逐人显示俘虏/逃脱；俘虏随队行军、入城后收押；攻击/击破触感反馈及开关；44类兵种、舰船、城关港和设施简易模型。低缩放仍显示占格物，火场/地形阻挡及攻击后下旬行军有明确提示。默认出征支持1主将+2副将，部队详情可查看每名武将。存档升级v16，兼容v1～v15。 三屏Android完整回归、覆盖升级、构建/Lint通过；[APK与验证记录](docs/validation/v020/README.md)。

全部核心回归及新增209条战果/寻路断言通过；Android构建与安装验证待CI完成。[本轮实现与规则边界](docs/BATTLE_MAP_V0_20.md)。**仍未达到100%还原**：原版逐格地图、完整官方开局、全事件/PK/特技交互和精确公式尚有缺口。
...
5. 「菜单 → 保存局面 / 读取存档」支持3个手动槽。自动存档在成功操作和进入后台时更新；当前写入v16，能读取v1～v15旧存档，旧手动槽对应现在的槽1。
