...
**v0.20.0 战果与地图模型开发版。** 击破缴获剩余金粮，逐人显示俘虏/逃脱；俘虏随队行军、入城后收押；攻击/击破触感反馈及开关；44类兵种、舰船、城关港和设施简易模型。低缩放仍显示占格物，火场/地形阻挡及攻击后下旬行军有明确提示。默认出征支持1主将+2副将，部队详情可查看每名武将。存档升级v16，兼容v1～v15。
