...
final class ArmyUi {
    ...
    void manufacture(World.City c){
        ...
        new AlertDialog.Builder(a).setTitle("军备制造 · 工期3旬").setItems(labels.toArray(new String[0]),(d,index)->choose("选择制造武将",w.idle(c),o->o.name+" · 政"+o.politics,o->{
            ...
            confirm("制造"+(weapon==null?ship.label:weapon.label),"金"+(weapon==null?ship.gold:Army.productionGold(weapon))+"、行动力10，占用"+o.name+"3旬。\n完成1件；城池失守或工场拆除时中止。",()->apply.accept(w.army.produce(c.id,o.id,weapon,ship)));
