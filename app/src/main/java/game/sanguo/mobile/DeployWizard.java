...
final class DeployWizard {
    ...
    private String error(){
        ...
        if(w.army.deploymentPreview(city,leader(),deputies(),weapon(),ship(),troops.value(),food.value(),gold.value())==null)return "城市中心受阻或没有本旬可达的合法出征格";return null;
    }
