...
final class LifecycleUi {
    ...
    private void button(LinearLayout p,String value,Runnable action){Button b=new Button(a);b.setText(value);b.setAllCaps(false);b.setMinHeight((int)(48*a.getResources().getDisplayMetrics().density));b.setOnClickListener(v->action.run());p.addView(b);}
