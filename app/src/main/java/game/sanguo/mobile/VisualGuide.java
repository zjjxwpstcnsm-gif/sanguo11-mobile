...
final class VisualGuide {
    ...
    private static void terrain(Activity a){
        ...
        String[] labels={"平地 · 正常通行，可开发内政设施","森林 · 移动力消耗增加，可伏兵","山峰 · 无法通行","水面 · 使用舰船与水军战法","山路 · 需要难所行军，消耗3移动力","浅滩 · 需要难所行军，消耗2移动力","栈道 · 消耗3移动力，未解锁技巧可能损兵","毒泉 · 经过会损兵，解毒特技可免疫","海洋 · 舰船通行，不划入陆地势力范围","地图边界 · 不可进入","沼泽 · 步兵消耗2、骑兵和器械消耗4移动力","堤坝 · 击破后相邻低地受到洪水影响","沙地 · 正常通行；枪兵在此不能施放战法，普通攻击不受影响"};
