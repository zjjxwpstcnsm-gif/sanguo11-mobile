...
public final class NationalMap {
    ...
    public static final int REVISION=60, COLUMNS=200, ROWS=200;
    ...
    public static String compatibilityNotice(World w){
        return ID.equals(w.mapId)&&(w.mapRevision==56||w.mapRevision==57||w.mapRevision==58||w.mapRevision==59)?
            "旧地图修订"+w.mapRevision+"：保留存档原地形、城市与部队，不自动迁移。本次水面与岸线地图修订仅对新开局生效；旧档地形和行军预算保持不变。请保留手动存档后重新开局体验修订"+REVISION+"。":"";
    }
