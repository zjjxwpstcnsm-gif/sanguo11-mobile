...
public final class ArmyTest {
    ...
    private static void formations()throws Exception{
        ...
        check(w.army.aptitude(u)==3&&w.army.intelligence(u)==99&&w.army.war(u)==98,"deputy stats and aptitude contribute");
        check(w.army.combatOfficer(u).leadership==70,"leadership remains commander");
