...
public final class LegacyMapCoordinateCheckpointTest {
    ...
    public static void main(String[] args){
        ...
        System.out.println("LegacyMapCoordinateCheckpointTest PASS: "+checks+" assertions; 40000 source slots; odd-r six-direction topology. Terrain/map revision NOT certified.");
    }
}
