...
public final class ScenarioNationalMapTest {
 public static void main(String[] args)throws Exception {
  ...
  for(ScenarioCatalog.Summary summary:ScenarioCatalog.summaries()){
   ...
   check(w.mapId.equals(NationalMap.ID)&&w.mapLayout.equals(NationalMap.LAYOUT)&&w.mapRevision==56,"shared authority "+summary.id);
   ...
   check(SaveCodec.decode(SaveCodec.encode(w)).mapRevision==56,"scenario save revision");
  }
