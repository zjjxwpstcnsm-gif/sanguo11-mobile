...
public final class StrategicManagementTest {
    ...
    private static void longRun()throws Exception{
        ...
        check(new DistrictManagement(w).residents(w.city(12))>0,"long-term vacant city acquires staff");check(w.domestic.count(12)>0||w.city(12).governorId>=0,"staff operates destination");
