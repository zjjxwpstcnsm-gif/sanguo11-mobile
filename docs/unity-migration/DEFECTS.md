...
| U01-03 | PARTIAL | Android host APK and androidTest compilation passed in workflow run 35809725433 from exact PR head `6685e703`. The emulator protocol probe remains in progress; there is no installed Android JNI runtime result. Do not infer a pass from compilation or the native APK. |
