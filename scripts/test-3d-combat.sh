...
for name in TileGeometry GridWorldTransform SceneCamera SceneMesh SiteVisual TerrainSurface MapSceneSnapshot FactionColors SiegeOverlay UnitVisual UnitMotion UnitAnimation CombatVisual; do
