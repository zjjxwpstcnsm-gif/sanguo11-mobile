...
find core/src/main/java -name '*.java' > app/build/field-sources.txt
for name in TileGeometry GridWorldTransform SceneCamera SceneMesh SiteVisual TerrainSurface TerrainMaterialField MapSceneSnapshot FactionColors SiegeOverlay UnitVisual UnitMotion UnitAnimation CombatVisual SiteGlb FieldAssets Vegetation; do
