...
for name in TileGeometry GridWorldTransform SceneCamera SceneMesh SiteVisual TerrainSurface WaterVisualField TerrainMaterialField MapSceneSnapshot FactionColors SiegeOverlay UnitVisual UnitMotion UnitAnimation UnitLod UnitFormation ScenePicking CombatVisual SiteGlb FieldAssets LandscapeProfile Vegetation; do
