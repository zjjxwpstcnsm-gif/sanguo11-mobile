...
for name in TileGeometry GridWorldTransform SceneCamera ScenePicking SceneMesh UnitVisual UnitMotion CombatVisual SiteVisual TerrainSurface TerrainMaterialField MapSceneSnapshot FactionColors SiegeOverlay; do
