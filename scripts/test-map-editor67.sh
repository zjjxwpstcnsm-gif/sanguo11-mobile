...
printf '%s\n' core/src/test/java/game/sanguo/core/MapBrushGeometryTest.java core/src/test/java/game/sanguo/core/MapRevisionLedgerTest.java core/src/test/java/game/sanguo/core/MapEditorContinuationTest.java core/src/test/java/game/sanguo/core/MapEditorRuntimeTest.java >> core/build/editor67-sources.txt
...
java -Xmx768m -cp core/build/editor67:core/src/main/resources game.sanguo.core.MapEditorRuntimeTest
