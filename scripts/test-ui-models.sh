...
printf '%s\n' app/src/main/java/game/sanguo/mobile/UiModels.java app/src/main/java/game/sanguo/mobile/MapCamera.java app/src/test/java/game/sanguo/mobile/PresentationTest.java >> app/build/ui-sources.txt
