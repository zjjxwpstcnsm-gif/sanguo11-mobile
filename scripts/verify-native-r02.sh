...
collect(){
 ...
 for part in 1 2 3 4 5; do adb pull "/sdcard/r02-operation-$part.mp4" out/r02/ || true; done
...
adb logcat -c
(for part in 1 2 3 4 5; do adb shell screenrecord --time-limit 180 "/sdcard/r02-operation-$part.mp4"; done) > out/r02/recording.txt 2>&1 &
record_job=$!
